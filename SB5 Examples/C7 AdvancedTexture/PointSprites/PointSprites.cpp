...
void SetupRC(void)
    ...
    starFieldShader = gltLoadShaderPairWithAttributes("PointSprites\\SpaceFlight.vp", "PointSprites\\SpaceFlight.fp", 2, GLT_ATTRIBUTE_VERTEX, "vVertex",
	...
	//LoadTGATexture("PointSprites\\star.tga", GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, GL_CLAMP_TO_EDGE);
	LoadTGATexture("TextureArrays\\moon00.tga", GL_LINEAR_MIPMAP_LINEAR, GL_LINEAR, GL_CLAMP_TO_EDGE);
    }
