...
const char *szCubeFaces[6] = { "MultiTexture\\pos_x.tga", "MultiTexture\\neg_x.tga", "MultiTexture\\pos_y.tga", "MultiTexture\\neg_y.tga", "MultiTexture\\pos_z.tga", "MultiTexture\\neg_z.tga" };
...
void SetupRC()
	...
	pBytes = gltReadTGABits("MultiTexture\\tarnish.tga", &iWidth, &iHeight, &iComponents, &eFormat);
    ...
    reflectionShader = gltLoadShaderPairWithAttributes("MultiTexture\\Reflection.vp", "MultiTexture\\Reflection.fp", 3, 
    ...
    skyBoxShader = gltLoadShaderPairWithAttributes("MultiTexture\\SkyBox.vp", "MultiTexture\\SkyBox.fp", 2, 
                                                GLT_ATTRIBUTE_VERTEX, "vVertex",
                                                GLT_ATTRIBUTE_NORMAL, "vNormal");
